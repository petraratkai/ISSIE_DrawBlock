...
The Mux4, Mux8, Demux4 and Demux8 components have been implemented as new ISSIE components. A few issues were encounterd when doing this:
...
- Different combinations of inputs were tested in simulation, ensuring that the output produces the correct value. Input combinations were not tested exhaustively due to the cheer number of combinations (particularly for the MUX/DEMUX8), but sufficient tests were performed until a high degree of confidence was achieved.