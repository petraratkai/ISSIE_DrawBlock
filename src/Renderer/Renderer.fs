    ...
    jsOptions<MenuItemConstructorOptions> <| fun invisibleMenu ->
        ...
        invisibleMenu.submenu <-
            [| // makeElmItem "Save Sheet" "CmdOrCtrl+S" (fun () -> ())
               ...
               makeElmItem "Rotate Left 90" "CmdOrCtrl+L" (fun () -> rotateDispatch Sheet.RotateMsg.Left90Degree)
               makeElmItem "Rotate Left 180" "CmdOrCtrl+B" (fun () -> rotateDispatch Sheet.RotateMsg.Left180Degree)
               makeElmItem "Rotate Left 270" "CmdOrCtrl+N" (fun () -> rotateDispatch Sheet.RotateMsg.Left270Degree)
               makeElmItem "Rotate Right 90" "CmdOrCtrl+R" (fun () -> rotateDispatch Sheet.RotateMsg.Right90Degree)
               makeElmItem "Rotate Right 180" "CmdOrCtrl+D" (fun () -> rotateDispatch Sheet.RotateMsg.Right180Degree)
               makeElmItem "Rotate Right 270" "CmdOrCtrl+S" (fun () -> rotateDispatch Sheet.RotateMsg.Right270Degree)
